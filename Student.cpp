...
Student::Student(char *nName, char *nId, char *nCourse, char *nPhone, double nGPA, int nCredit)
{
	strcpy_s(name, nName);
	strcpy_s(id, nId);
	strcpy_s(course, nCourse);
	strcpy_s(phone_no, nPhone);
	current_cgpa = nGPA;
	totalCreditsEarned = nCredit;
	exam_cnt = 0;
}
